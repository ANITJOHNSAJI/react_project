...
export default function Contact() {
    return (
        ...
        <div>
            <Nav />
            <h1>About</h1>
            <h3>Our approach is very simple. We treat all the students equally. Everyone will get equal treatment and attention. Even if you are a fresher or an experienced candidate</h3>
